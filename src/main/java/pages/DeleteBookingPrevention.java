...
public class DeleteBookingPrevention extends BasePage{

	public DeleteBookingPrevention(WebDriver driver, WebActionUtil webActionUtil) {
	...
	private WebElement ClickOnDeleteBtn2;
	
	public void deleteBookingPrevention() throws InterruptedException {
		...
		webActionUtil.clickOnElement(ClickOnDeleteBtn2);
		Reporter.log("Booking Prevention deleted", true);
	}
